...
Програма виконувала завдання кілька разів, і для статистики наведено середній час виконання кожної задачі.
![Гистограмма времени выполнения](execution_time.png)
...
app ./data/100x100/
```
**Результат виконання** - файл ```_combined.png```, який об’єднує файли ```color_mask.png``` та ```mask.png``` з папки ```[path/to/folder]```.
...
app ./data/100x100/
```
**Результат виконання** - файл  ```_result.png``` який є результатом основного завдання — заповнення файлу ```mask.png``` ннайчастішим кольором сегменту з ```color_mask.png```.
